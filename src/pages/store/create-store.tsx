      ...
      <div className="grid grid-cols-2 min-h-[80vh] px-16 pt-40">
        ...
        <div className="col-span-1 flex flex-col items-start justify-start p-8">
          <div className="border-2 border-slate-100 p-5 rounded-xl min-w-[90%]">
            <h2 className="mb-4">
              Halo, <b>{name.split(" ")[0] || "User"}</b> ayo isi detail tokomu!
            </h2>
              ...
              <div className="flex w-full">
                ...
                {openAddress ? (
                  <div className="flex flex-col w-full mb-2">
                    ...
                    <p className="font-semibold mb-2">{formState.phone ? formState.phone : phone}</p>
                  </div>
                ) : (
                  <div className="flex flex-col w-full">
                    <h2 className="text-lg font-bold">Masukkan No. HP-mu</h2>
                    <input type="number" defaultValue={formState.phone ? formState.phone : phone} name="phone" maxLength={13} onChange={(e) => onChange(e, "phone")} className="border border-gray-400 w-full my-1 p-3 focus:outline-none focus:ring-1 focus:ring-green-500 rounded-lg" />
                  </div>
                )}
              </div>
                  ...
                  {openAddress === true && (
                    <>
                      ...
                      <div className="w-full relative">
                        ...
                        <input type="number" name="kodePost" defaultValue={kodePost} maxLength={60} onChange={(e) => onChangeAddress(e, "kodePost")} className="border border-gray-400 w-full my-1 p-3 focus:outline-none focus:ring-1 focus:ring-green-500 rounded-lg" />
